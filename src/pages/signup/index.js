...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const emptyFields = Object.entries(inputValues).filter(([name, value]) => value === "");
        ...
        // POST request to api
        try {
            const response = await axios.post("/api/auth/register/", inputValues);
            ...
            response.data && router.push("/login");
        } catch (error) {
            // console.log(error);
        ...
        <main className={`${style.signup_page}`}>
            <section className={`${style.signup_section}`}>
                <div className={`${style.form_card}`}>
                    ...
                    <form className={`${style.signup_form}`} action="" onSubmit={handleSubmit}>
                        <div className={`${style.input_field}`}>
                            <label htmlFor="username" className={`${style.signup_form__label}`}>
                                Username
                                <input
                                    className={`${style.signup_form__email}`}
                                    type="text"
                                    name="username"
                                    id="username"
                        ...
                        <div className={`${style.input_field}`}>
                            <label htmlFor="email" className={`${style.signup_form__label}`}>
                                Email
                                <input
                                    className={`${style.signup_form__email}`}
                                    type="email"
                        ...
                        <div className={`${style.input_field}`}>
                            <label
                                htmlFor="password"
                                className={`${style.signup_form__label} ${style.password}`}
                            >
                                Password
                                <input
                                    className={`${style.signup_form__password} `}
